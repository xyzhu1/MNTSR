...
from model import mntsr, tbsrn, tsrn, edsr, srcnn, srresnet, crnn,moran,recognizer,vdsr,rdn,lapsrn,han,rcan
...
class TextBase(object):
    ...
    def generator_init(self):
        cfg = self.config.TRAIN
        if self.args.arch == 'mntsr':
            model = mntsr.MNTSR(scale_factor=self.scale_factor, width=cfg.width, height=cfg.height,
